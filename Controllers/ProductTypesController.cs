...
namespace ABCMufflerAndHitch.Controllers
{
    public class ProductTypesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ProductTypeID,ProductTypeName,Category")] ProductType productType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProductTypeID,ProductTypeName,Category")] ProductType productType)
        {
        ...
        {
            var categories = from CategoryEnum e in Enum.GetValues(typeof(CategoryEnum))
                             select new
                             {
                                 ID = (int)e,
                                 Name = e.ToString()
